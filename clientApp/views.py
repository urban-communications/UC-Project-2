    ...
    def post(self, request):
        if request.user.is_staff:
            ...
            if adminChatForm.is_valid():
                ...
                data.sender = 'Urban Communications'
        ...
        if request.user.operator:
            ...
            if form.is_valid():
                ...
                if(total_days >= 1):
                    ...
                    Kindly check and approve or decline from your account by login at: <a href="http://www.app.urban-communications.co.uk/">http://www.app.urban-communications.co.uk</a> 
                    </p>
                    </div>"""
    ...
    if request.user.is_staff:
        ...
        if leave.client_leave_status == "Approved":
            ...
            html_content = f"""<p>Hi {leave.operator_id.operator_name}, <br> 
                ...
                You can login by visiting our website for more details: <a href="http://www.app.urban-communications.co.uk/">http://www.app.urban-communications.co.uk</a>  </p>
                """
            msg = EmailMultiAlternatives(
                subject, text_content, from_email, [to])
            msg.attach_alternative(html_content, "text/html")
